...
export class default1660696712270 implements MigrationInterface {
    name = 'default1660696712270'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sujects" ("id" SERIAL NOT NULL, "name" text NOT NULL, CONSTRAINT "PK_5a30a178620c982ab6aa61c2b78" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "room_subject" ADD CONSTRAINT "FK_f227421d2ef64ab086261ac07fd" FOREIGN KEY ("room_id") REFERENCES "sujects"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "sujects"`);
    }
